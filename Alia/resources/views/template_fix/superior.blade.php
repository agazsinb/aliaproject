...
<header id="home">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li><a href="/id/superior"><img class="img-responsive" src="{{ URL::asset('images/indonesia.png') }}" height="25" width="25" alt="logo"></a></li>     
          </ul>
        </div>
      </div>
      </div><!--/#main-nav-->
  ...
  <div class="container" style="padding-bottom: 10px ;margin-top:25px; margin-bottom: 25px;">
          ...
          <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="active item">
                    <div class="fill img-responsive" style="background-image: url({{ URL::asset('images/room/superior/superior.jpg') }}); height:400px; width:750px;"></div>
                </div>
                <div class="item">
                    <div class="fill img-responsive" style="background-image: url({{ URL::asset('images/room/superior/superior2.jpg') }}); height:400px; width:750px;"></div>
                </div>
                <div class="item">
                    <div class="fill img-responsive" style="background-image: url({{ URL::asset('images/room/superior/superior3.jpg') }}); height:400px; width:750px;"></div>
                </div>
            </div>
            <!-- Carousel nav -->
            ...
            <div class="panel">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <p style="font-size:16px;">AC 1PK <i class="fa fa-circle-o biru"></i> TV 24 Inch <i class="fa fa-circle-o biru"></i> Refrigerator <i class="fa fa-circle-o biru"></i> Free Wi-Fi <i class="fa fa-circle-o biru"></i> Coffee & Tea Maker</p>
                    </div>
                </div>
            </div>
            <div class="panel">
    ...
    <div class="row" style="margin-top: 10px;">
      <div class="col-sm-4">
        <h1><b class="navy text-center">Rp. 540.000/Night</b></h1>
