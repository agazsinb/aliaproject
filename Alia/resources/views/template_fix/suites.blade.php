...
<header id="home">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li><a href="/en/suites"><img class="img-responsive" src="{{ URL::asset('images/indonesia.png') }}" height="25" width="25" alt="logo"></a></li>
  ...
  <section id="suites" class="parallax inner-shadow" style="margin-top: 50px;">
    <div class="container">
      <div class="row" >
        <div class="col-sm-12">
        <h1> <b>R</b>OOMS &<b> S</b>UITES</h1>
        </div>
      </div>
    </div>
  ...
  <div class="container" style="padding-bottom: 10px ;margin-top:25px; margin-bottom: 25px;">
    <div class="row">
          ...
          <figure class="thumbnail">
            <div class="view view-first">
              <img src="{{ URL::asset('images/room/standard2.jpg') }}"/>
                <div class="mask">
                    <h2>STANDARD</h2>
                    <p>TV 24 Inch - Refigrator - AC 1PK - Hotel directory - Bath towel 2 - Free Wi-fi </p>
      ...
      <div class="col-sm-4">
          <figure class="thumbnail">
            <div class="view view-first">
              <img src="{{ URL::asset('images/room/superior/superior.jpg') }}" />
                <div class="mask">
                    <h2>SUPERIOR</h2>
                    <p>TV 24 Inch - Refigrator - AC 1PK - Hotel directory - Free Wi-Fi - Bath towel 2 - Coffe Maker</p>
                    <a href="/en/room-reservation" class="info">BOOK NOW</a>
                </div>
            </div>  
              <figcaption class="caption">
          ...
          <figure class="thumbnail">
            <div class="view view-first">
              <img src="{{ URL::asset('images/room/deluxe.jpg') }}" />
                <div class="mask">
                    <h2>DELUXE</h2>
                    <p>TV 32 Inch - Refigrator - AC 1PK - Hotel directory - Free Wi-Fi - Bath towel 2 - New Interior</p>
    ...
    <div class="row">
      <div class="col-sm-4">
          <figure class="thumbnail">
            <div class="view view-first">
              <img src="{{ URL::asset('images/room/suite/suite2.jpg') }}" />
                <div class="mask">
                    <h2>SUITE</h2>
                    <p>TV 39 Inch - Refigrator - 2 AC (1PK & 2PK) - Hotel directory - Free Wi-Fi - Bath towel 2 - Balcony</p>
                    <a href="/en/room-reservation" class="info">BOOK NOW</a>
                </div>
            </div>  
              <figcaption class="caption">
      ...
      <div class="col-sm-4">
          <figure class="thumbnail">
            <div class="view view-first">
              <img src="{{ URL::asset('images/room/family/family1.jpg') }}" />
                <div class="mask">
                    <h2>FAMILY</h2>
                    <p>TV 40 Inch - Refigrator - 2 AC (1PK & 2PK) - Hotel directory - Free Wi-Fi - Bath towel 4 - Balcony</p>
                    <a href="/en/room-reservation" class="info">BOOK NOW</a>
                </div>
            </div>  
              <figcaption class="caption">
      ...
      <div class="col-sm-4">
          <figure class="thumbnail">
            <div class="view view-first">
              <img src="{{ URL::asset('images/room/family/family.jpg') }}" />
                <div class="mask">
                    <h2>EXECUTIVE FAMILY</h2>
                    <p>TV 40 Inch - Refigrator - 2 AC (1PK & 2PK) - Hotel directory - Free Wi-Fi - Bath towel 4 - Balcony - More space</p>
                    <a href="en/room-reservation" class="info">BOOK NOW</a>
                </div>
            </div>  
              <figcaption class="caption">
