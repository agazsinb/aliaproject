...
<header id="home">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li><a href="/en/family"><img class="img-responsive" src="{{ URL::asset('images/english.png') }}" height="25" width="25" alt="logo"></a></li>     
          </ul>
        </div>
      </div>
      </div><!--/#main-nav-->
  ...
  <div class="container" style="padding-bottom: 10px ;margin-top:25px; margin-bottom: 25px;">
            ...
            <div class="panel">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <p style="font-size:16px;">2 AC (1PK & 2PK) <i class="fa fa-circle-o biru"></i> TV 40 Inch <i class="fa fa-circle-o biru"></i> Kulkas <i class="fa fa-circle-o biru"></i> Wi-Fi Gratis <i class="fa fa-circle-o biru"></i> Coffee & Tea Maker <i class="fa fa-circle-o biru"></i> Balcony <i class="fa fa-circle-o biru"></i> Fasilitas untuk 4 orang</p>
                    </div>
                </div>
            </div>
            <div class="panel">
    ...
    <div class="row" style="margin-top: 10px;">
      <div class="col-sm-4">
        <h1><b class="navy text-center">Rp. 850.000/Malam</b></h1>
      ...
      <br>
      <div class="col-sm-4">
        <center><a href="/id/room-reservation" class="bookbtn">BOOK NOW</a></center>
      </div>
