...
<header id="home">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li><a href="/id/suiteroom"><img class="img-responsive" src="{{ URL::asset('images/indonesia.png') }}" height="25" width="25" alt="logo"></a></li>     
          </ul>
        </div>
      </div>
      </div><!--/#main-nav-->
  ...
  <div class="container" style="padding-bottom: 10px ;margin-top:25px; margin-bottom: 25px;">
            ...
            <div class="panel">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <p style="font-size:16px;">2 AC (1PK & 2PK) <i class="fa fa-circle-o biru"></i> TV 39 Inch <i class="fa fa-circle-o biru"></i> Refrigerator <i class="fa fa-circle-o biru"></i> Free Wi-Fi <i class="fa fa-circle-o biru"></i> Coffee & Tea Maker <i class="fa fa-circle-o biru"></i> Balcony</p>
                    </div>
                </div>
            </div>
            <div class="panel">
    ...
    <div class="row" style="margin-top: 10px;">
      <div class="col-sm-4">
        <h1><b class="navy text-center">Rp. 730.000/Night</b></h1>
