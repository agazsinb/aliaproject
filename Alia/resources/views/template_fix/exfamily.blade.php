...
<header id="home">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li><a href="/id/executive-family"><img class="img-responsive" src="{{ URL::asset('images/indonesia.png') }}" height="25" width="25" alt="logo"></a></li>     
          </ul>
        </div>
      </div>
      </div><!--/#main-nav-->
  ...
  <div class="container" style="padding-bottom: 10px ;margin-top:25px; margin-bottom: 25px;">
    ...
    <div class="row" style="margin-top: 10px;">
      <div class="col-sm-4">
        <h1><b class="navy text-center">Rp. 930.000/Night</b></h1>
