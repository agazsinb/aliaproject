...
<header id="home">
  ...
  <section id="deluxehead" class="parallax inner-shadow" style="margin-top: 50px;">
    <div class="container">
      <div class="row" >
        <div class="col-sm-12">
        <h1> <b>D</b>ELUXE</h1>
  ...
  <div class="container" style="padding-bottom: 10px ;margin-top:25px; margin-bottom: 25px;">
          ...
          <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="active item">
                    <div class="fill img-responsive" style="background-image: url({{ URL::asset('images/room/deluxe/deluxe2.jpg') }}); height:400px; width:750px;"></div>
                </div>
                <div class="item">
                    <div class="fill img-responsive" style="background-image: url({{ URL::asset('images/room/deluxe/deluxe4.jpg') }}); height:400px; width:750px;"></div>
                </div>
                <div class="item">
                    <div class="fill img-responsive" style="background-image: url({{ URL::asset('images/room/deluxe/Deluxe_Room2.jpg') }}); height:400px; width:750px;"></div>
                </div>
            </div>
            <!-- Carousel nav -->
            ...
            <div class="panel">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <p style="font-size:16px;">AC 1PK <i class="fa fa-circle-o biru"></i> TV 32 Inch <i class="fa fa-circle-o biru"></i> Kulkas <i class="fa fa-circle-o biru"></i> Wi-Fi Gratis<i class="fa fa-circle-o biru"></i> Coffee & Tea Maker</p>
                    </div>
                </div>
            </div>
            <div class="panel">
                ...
                <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body">
                        <p style="font-size: 16px;">24 jam room service <i class="fa fa-circle-o biru"></i> Restoran <i class="fa fa-circle-o biru"></i> Laundry <i class="fa fa-circle-o biru "></i> Ruang Rapat <i class="fa fa-circle-o biru"></i> Business Center <i class="fa fa-circle-o biru"></i> Masjid <i class="fa fa-circle-o biru"></i> Non-Smoking Room</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row" style="margin-top: 10px;">
      <div class="col-sm-4">
        <h1><b class="navy text-center">Rp. 590.000/Malam</b></h1>
