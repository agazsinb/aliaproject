...
<header id="home">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li ><a href="/en/meetings" style="color:#dbb13b;">MEETINGS</a></li>
            <li><a href="/en/wedding">WEDDINGS</a></li>
            <li><a href="/en/room-reservation">BOOK NOW</a></li> 
            <li><a href="/en/feedback">CONTACT US</a></li>

            <li><a href="/id/meetings"><img class="img-responsive" src="{{ URL::asset('images/indonesia.png') }}" height="25" width="25" alt="logo"></a></li>      
          </ul>
        </div>
      </div>
      </div><!--/#main-nav-->
  ...
  <div class="container" style="padding-bottom: 10px ;margin-top:25px; margin-bottom: 25px;">
    ...
    <div class="row">
      ...
      <b>Meeting packages are available.</b>

      </div>

      <div class="col-sm-6">
        <h2 class="black h24 text-center">MEETING ROOM DETAILS</h2>
        ...
        <figure class="thumbnail" style="margin-bottom:10px;font-size: 20px;">
          ...
          <figcaption class="caption">
            <b>KETAPANG KENCANA  </b><i class="fa fa-user biru desc2"></i>270-580 Person <i class="fa fa-expand biru desc2"></i>340.75 M²
          </figcaption>

          <figcaption class="caption">
            <b>ADELIA</b><i class="fa fa-user biru desc2"></i>90-150 Person <i class="fa fa-expand biru desc2"></i>142.5 M²
          </figcaption>

          <figcaption class="caption">
            <b>SEPATU DEA  </b><i class="fa fa-user biru desc2"></i>50-120 Person <i class="fa fa-expand biru desc2"></i>115.5 M² 
          </figcaption>

          <figcaption class="caption">
            <b>TRAMBESI  </b><i class="fa fa-user biru desc2"></i>30-80 Person <i class="fa fa-expand biru desc2"></i>60 M² 
          </figcaption>

          <figcaption class="caption">
            <b>PURING  </b><i class="fa fa-user biru desc2"></i>10-15 Person <i class="fa fa-expand biru desc2"></i>24 M²
          </figcaption>
        </figure>
    ...
    <div class="row" style="margin-top:50px;">
      <div class="col-sm-4 col-sm-offset-4">
        <center><a href="/en/meeting-reservation" class="bookbtn">BOOK NOW</a></center>
      </div>
    </div>
