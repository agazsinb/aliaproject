      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li><a href="/en/superior"><img class="img-responsive" src="{{ URL::asset('images/english.png') }}" height="25" width="25" alt="logo"></a></li>    
          </ul>
        </div>
      </div>
      </div><!--/#main-nav-->
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel">
                ...
                <div id="collapseTwo" class="panel-collapse collapse">
                    <div class="panel-body">
                        <p style="font-size: 16px;">24 jam room service <i class="fa fa-circle-o biru"></i> Restoran <i class="fa fa-circle-o biru"></i> Laundry <i class="fa fa-circle-o biru "></i> Ruang Rapat <i class="fa fa-circle-o biru"></i> Business Center <i class="fa fa-circle-o biru"></i> Parkir <i class="fa fa-circle-o biru"></i> Non-Smoking Room</p>
                    </div>
                </div>
            </div>
        </div>
